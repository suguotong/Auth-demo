...
public interface UserRepository extends JpaRepository<UserEntity, Integer> {
    ...
    UserEntity findByAccountAndRoleId(String account,Integer roleId);
    ...
    @Query(value="SELECT center_id as centerId ,center_name as centerName ,count(center_id) as jxsNum from user_entity WHERE  if(?1 !='',center_name like %?1% ,1=1) and role_id =2 GROUP BY center_id,center_name" ,nativeQuery = true)
    List<Object[]> getCenterList(String center_name);
